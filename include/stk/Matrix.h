...
public:
	...
	inline double& operator()(int i, int j) { assert((i<sizei)); assert((j<sizej)); return data[i*sizej + j]; }
	inline const double& operator()(int i, int j) const { assert((i<sizei)); assert((j<sizej)); return data[i*sizej + j]; }
